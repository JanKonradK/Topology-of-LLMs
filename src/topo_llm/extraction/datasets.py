...
class DatasetGenerator:
    ...
    FACTUAL_PAIRS: list[tuple[str, str, str]] = [
        ...
        (
            ...
            "The Amazon River flows through Argentina.",
        ),
        (
            "geography",
        ...
        (
            ...
            "Iceland is located in the South Pacific.",
        ),
        (
            "geography",
            "The Great Wall of China is visible from the ground.",
        ...
        (
            ...
            "The Ganges River flows through Pakistan.",
        ),
        (
            "geography",
        ...
        (
            ...
            "The Caspian Sea is the lowest point on land.",
        ),
        ...
        (
            ...
            "Photosynthesis converts oxygen into CO2.",
        ),
        ...
        (
            ...
            "Gravity accelerates objects at 12.5 m/s² on Earth.",
        ),
        (
            "science",
        ...
        (
            ...
            "Helium is the third lightest element.",
        ),
        (
            "science",
            "Antibiotics kill bacteria, not viruses.",
            "Antibiotics kill both bacteria and viruses equally.",
        ),
        ...
        (
            ...
            "The printing press was invented by Da Vinci.",
        ),
        ...
        (
            ...
            "Alexander the Great was from Sparta.",
        ),
        ...
        (
            ...
            "Columbus reached the Americas in 1488.",
        ),
        (
            "history",
            "The Industrial Revolution started in Britain.",
            "The Industrial Revolution started in Germany.",
        ),
        (
            "history",
            "The Cold War ended with the dissolution of the USSR.",
            "The Cold War ended with the fall of the Berlin Wall alone.",
        ),
        # Mathematics
        ...
        (
            ...
            "There are exactly one million prime numbers.",
        ),
        (
            "mathematics",
            "The Fibonacci sequence starts with 0, 1, 1, 2, 3.",
            "The Fibonacci sequence starts with 1, 2, 3, 5, 8.",
        ),
        (
            "mathematics",
            "Euler's number e is approximately 2.718.",
            "Euler's number e is approximately 2.618.",
        ),
